...
export const footerLinks = [
  {
    ...
    links: [
      ...
      { text: "Offers & Deals", url: "/offersanddeals" },
  ...
  },
  {
    title: "Need help?",
    links: [
      { text: "Delivery Information", url: "/underDevelopment" },
      { text: "Return & Refund Policy", url: "/returnandrefaundpolicy" },
      { text: "Payment Methods", url: "/paymentmethods" },
      { text: "Track your Order", url: "/underDevelopment" },
      { text: "Contact Us", url: "/contact" },
    ],
  },
  {
    title: "Follow Us",
    links: [
      { text: "Instagram", url: "/underDevelopment" },
      { text: "Twitter", url: "/underDevelopment" },
      { text: "Facebook", url: "/underDevelopment" },
      { text: "YouTube", url: "/underDevelopment" },
    ],
  },
];
